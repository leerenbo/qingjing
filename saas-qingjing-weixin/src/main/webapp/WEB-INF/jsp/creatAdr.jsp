	...
	<div class="C_warp page M_creatAdr" id=''>
		...
		<div class="content">
			<div class="adrlist">
				<div class="adr1">
					<p class="p1">
						姓名 <span>138****1234</span>
					</p>
					<p class="p2">
						<span class="province ">辽宁省</span><span class="city">大连市</span><span class="district">中山区</span><span class="specific">桃园街16号 3-5-1桃园街16号 3-5-1桃园街16号 3-5-1桃园街16号 3-5-1</span>
					</p>
				</div>
				<div class="adr1">
					<p class="p1">
	...
	<script>
		$(function() {
			...
			$("#plusAdr").click(function() {
				$.router.loadPage('creatAdr2.html');
			});
		});
	</script>
</body>
