...
import com.lrb.saas.core.model.qingjing.order.Pay;
...
public class PayController extends BaseController<Pay> {
	...
	public SAASResponse<Pay> get(String id) throws Exception {
		return super.get(id);
	}
	...
	public SAASResponse post(@Validated(POST.class) @RequestBody SAASRequest<Pay> request, BindingResult bindingResult)
			throws Exception {
	...
	public SAASResponse put(@Validated(PUT.class) @RequestBody SAASRequest<Pay> request, BindingResult bindingResult)
			throws Exception {
	...
	public SAASResponse patch(@Validated(PATCH.class) @RequestBody SAASRequest<Pay> request,
	...
	public SAASResponse delete(@Validated(DELETE.class) @RequestBody SAASRequest<Pay> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASQueryResponse<Pay> query(@RequestBody SAASRequest<SAASQueryRequest> request) throws Exception {
