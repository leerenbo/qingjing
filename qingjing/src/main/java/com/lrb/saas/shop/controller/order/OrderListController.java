...
public class OrderListController extends BaseController<OrderList> {

	@Override
	@GetMapping
	@SAASInterface(name = "获取", remark = "?id=主键 传值")
	public SAASResponse<OrderList> get(String id) throws Exception {
		return super.get(id);
	}
	...
	public SAASResponse post(@Validated(POST.class) @RequestBody SAASRequest<OrderList> request,
	...
	public SAASResponse put(@Validated(PUT.class) @RequestBody SAASRequest<OrderList> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASResponse patch(@Validated(PATCH.class) @RequestBody SAASRequest<OrderList> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASResponse delete(@Validated(DELETE.class) @RequestBody SAASRequest<OrderList> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASQueryResponse<OrderList> query(@RequestBody SAASRequest<SAASQueryRequest> request) throws Exception {
