...
public class PayBusiness {
    ...
    public PayBusiness() throws IllegalAccessException, ClassNotFoundException, InstantiationException {
    ...
    public interface ResultListener {
        ...
        //支付成功
        void onSuccess(PayResData scanPayResData);

    }

    //打log用
    private static Log log = new Log(LoggerFactory.getLogger(PayBusiness.class));
     ...
     * @throws Exception
     */
    public void run(PayReqData scanPayReqData, ResultListener resultListener) throws Exception {
