...
import com.tencent.business.PayBusiness;
...
public class WXPay {
     ...
     * @throws Exception
     */
    public static String requestScanPayService(PayReqData scanPayReqData) throws Exception{
     ...
     * @throws Exception
     */
	public static String requestPayQueryService(PayQueryReqData payQueryReqData) throws Exception{
		return new ScanPayQueryService().request(payQueryReqData);
	}
     ...
     * @throws Exception
     */
    public static void doScanPayBusiness(PayReqData scanPayReqData, PayBusiness.ResultListener resultListener) throws Exception {
        new PayBusiness().run(scanPayReqData, resultListener);
    }
