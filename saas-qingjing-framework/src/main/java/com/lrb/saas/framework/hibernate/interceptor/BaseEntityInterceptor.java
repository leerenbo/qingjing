package com.lrb.saas.framework.hibernate.interceptor;
...
public class BaseEntityInterceptor extends EmptyInterceptor {
	...
	private static final String CREATE_DATE = "_createTime";// "创建日期"属性名称
	private static final String MODIFY_DATE = "_modifyTime";// "修改日期"属性名称
