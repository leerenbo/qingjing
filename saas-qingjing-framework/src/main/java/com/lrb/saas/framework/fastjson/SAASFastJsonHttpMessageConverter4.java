 ...
 */
public class SAASFastJsonHttpMessageConverter4 extends AbstractGenericHttpMessageConverter<Object> {
	 ...
	 */
	public SAASFastJsonHttpMessageConverter4() {
		super(MediaType.ALL);
	}
	...
	protected void writeInternal(Object obj, Type type, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
		...
		FastJsonConfig fastJsonConfig = this.fastJsonConfig;
		if (SAASResponse.class.isInstance(obj)) {
			SAASResponse saasResponse = (SAASResponse) obj;
			if (saasResponse.getFastJsonConfig() != null) {
				fastJsonConfig = saasResponse.getFastJsonConfig();
			}
		}
