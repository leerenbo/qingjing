...
public class ProductionTypeController extends BaseController<ProductionType> {

	@Override
	@GetMapping
	@SAASInterface(name = "获取产品", remark = "?id=主键 传值")
	public SAASResponse<ProductionType> get(String id) throws Exception {
		return super.get(id);
	}
	...
	public SAASResponse post(@Validated(POST.class) @RequestBody SAASRequest<ProductionType> request, BindingResult bindingResult) throws Exception {
	...
	public SAASResponse put(@Validated(PUT.class) @RequestBody SAASRequest<ProductionType> request, BindingResult bindingResult) throws Exception {
	...
	public SAASResponse patch(@Validated(PATCH.class) @RequestBody SAASRequest<ProductionType> request, BindingResult bindingResult) throws Exception {
	...
	public SAASResponse delete(@Validated(DELETE.class) @RequestBody SAASRequest<ProductionType> request, BindingResult bindingResult) throws Exception {
		return super.delete(request, bindingResult);
	}

	@Override
	@RequestMapping(value = "/query")
	public SAASQueryResponse<ProductionType> query(@RequestBody SAASRequest<SAASQueryRequest> request) throws Exception {
