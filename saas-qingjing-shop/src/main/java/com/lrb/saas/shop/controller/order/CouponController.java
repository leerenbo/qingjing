...
import com.lrb.saas.core.model.qingjing.order.Coupon;
...
public class CouponController extends BaseController<Coupon> {
	...
	public SAASResponse<Coupon> get(String id) throws Exception {
		return super.get(id);
	}
	...
	public SAASResponse post(@Validated(POST.class) @RequestBody SAASRequest<Coupon> request,
	...
	public SAASResponse put(@Validated(PUT.class) @RequestBody SAASRequest<Coupon> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASResponse patch(@Validated(PATCH.class) @RequestBody SAASRequest<Coupon> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASResponse delete(@Validated(DELETE.class) @RequestBody SAASRequest<Coupon> request,
			BindingResult bindingResult) throws Exception {
	...
	public SAASQueryResponse<Coupon> query(@RequestBody SAASRequest<SAASQueryRequest> request) throws Exception {
